...
!function (n) {
    ...
    var e, n, p, o, r, h, f, g, m, v, y, s, i, _, a,
        a = (t && t.fn && t.fn.select2 && t.fn.select2.amd && (u = t.fn.select2.amd), u && u.requirejs || (u ? n = u : u = {}, g = {}, m = {}, v = {}, y = {}, s = Object.prototype.hasOwnProperty, i = [].slice, _ = /\.js$/, h = function (e, t) {
            ...
            return t = t || function () {
            }, "function" == typeof n && (n = s, s = i), s ? o(p, e, t, n) : setTimeout(function () {
                o(p, e, t, n)
            }, 4), r
        }, r.config = function (e) {
            return r(e)
        ...
        }).amd = {jQuery: !0}, u.requirejs = e, u.require = n, u.define = a), u.define("almond", function () {
            ...
            return s.Extend(o, s.Observable), o.prototype.render = function () {
                ...
                return this._tabindex = -1, null != s.GetData(this.$element[0], "old-tabindex") ? this._tabindex = s.GetData(this.$element[0], "old-tabindex") : null != this.$element.attr("tabindex") && (this._tabindex = this.$element.attr("tabindex")), e.attr("title", this.$element.attr("title")), e.attr("tabindex", -1), e.attr("aria-disabled", "false"), this.$selection = e;
                ...
                this.container = e, this.$selection.on("focus", function (e) {
                    ...
                    n.$selection.attr("tabindex", "-1"), n.$selection.attr("aria-disabled", "false")
            ...
            return c.Extend(o, e), o.prototype.render = function () {
                ...
                if (this.clear(), 0 !== e.length) {
                    for (var t = [], n = this.$selection.find(".select2-selection__rendered").attr("id") + "-choice-", s = 0; s < e.length; s++) {
                        var i = e[s], o = this.selectionContainer(), r = this.display(i, o),
            ...
            return e.prototype.query = function (e, c, u) {
                ...
                this._removeOldTags(), null != c.term && null == c.page ? e.call(this, c, function e(t, n) {
                    for (var s = t.results, i = 0; i < s.length; i++) {
                        var o = s[i], r = null != o.children && !e({results: o.children}, !0);
            ...
            return e.prototype.render = function (e) {
                ...
                e.call(this, t, n), this.$search.on("keydown", function (e) {
                    ...
                    s.$search.attr("tabindex", -1), s.$search.attr("aria-controls", i), s.$search.trigger("focus"), window.setTimeout(function () {
                        s.$search.trigger("focus")
                    }, 0)
                }), t.on("close", function () {
            ...
            return e.prototype.bind = function (e, t, n) {
                ...
                var n = this, s = "scroll.select2." + t.id, i = "resize.select2." + t.id,
                    o = "orientationchange.select2." + t.id, t = this.$container.parents().filter(r.hasScroll);
                t.each(function () {
                ...
                var r = this.$dropdown.outerHeight(!1), a = e.scrollTop(), l = e.scrollTop() + e.height(),
                    c = a < i.top - r, e = l > i.bottom + r, a = {left: i.left, top: o.bottom},
